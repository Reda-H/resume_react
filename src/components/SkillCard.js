...
function SkillCard({skill}) {
    return(
        <Card className="text-center ml-2 mr-2 mt-1" style={{ minHeight: '135px', maxWidth: '12.5%', minWidth: '95px', border: 'none', boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px',}}>
            ...
            <Card.Footer className="pl-0 pr-0">{skill.name}</Card.Footer>
        </Card>
    );
}
