                    ...
                    <div className="mt-5">
                        ...
                        <Row style={{ display: 'flex', alignItems: 'center' }}>
                            <Col className="mt-3" md={6}>
                                <Card className="second-color-background fifth-color" style={{ boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', }}>
                                    <Card.Body>
                                        <Row>
                            ...
                            <Col className="mt-3" md={6}>
                                <Card className="second-color-background fifth-color" style={{ height: '100%', boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', }}>
